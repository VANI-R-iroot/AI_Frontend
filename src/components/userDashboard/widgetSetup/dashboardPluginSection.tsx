...
const DashboardPluginSection: React.FC = () => {
  ...
  return (
    <div className="user-dashboard-section-0">
      {showTrainPlugin ? (
        ...
        <div className="row">
          {pluginList.slice(0, 4).map((card) => {
            const isLiked = isPluginLikedByUser(card);

            return (
              <div
                key={card._id}
                className="col-sm-12 col-md-12 col-lg-6 col-xl-3 col-xxl-3"
              >
...
export default DashboardPluginSection;
